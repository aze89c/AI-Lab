...
However, those are just the simple use cases and basic predefined logics; you can even perform arithmetic operations and apply complex "family tree" logic-based rules and conditions for further provisions. 
